document.addEventListener('DOMContentLoaded', () => {
    ...
    emailjs.init("-7zzMb1Hp7BzTQ9jR");
    document.getElementById('supportForm')?.addEventListener('submit', (e) => {
        e.preventDefault();
        emailjs.sendForm('service_vrqdc78', 'template_zmogqaj', e.target)
            .then(() => alert("Ticket submitted successfully! We will respond within 24 hours."))
            .catch(() => alert("Error sending ticket."));
        e.target.reset();
    });
